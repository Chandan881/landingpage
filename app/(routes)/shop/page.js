...
export default function ShopLanding() {
  ...
  return (
    <main className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-b from-white to-[#E3E1FF] py-20 lg:py-32">
        <Container>
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-12 leading-relaxed max-w-3xl mx-auto">
              ZenZee merchants enjoy more orders, increased sales, and unmatched
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                href="#"
                className="bg-black hover:bg-gray-800 text-white px-8 py-4 text-lg font-semibold rounded-xl transition-colors duration-300 flex items-center gap-3"
              >
                <svg
                  className="w-6 h-6"
                  viewBox="0 0 24 24"
